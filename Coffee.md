...
|---- | ---- | ---- | ---- | ---- |----| ----| ----|
|⭐️ [Blue Bottle Coffee]([https://www.highwirecoffee.com/](https://bluebottlecoffee.com/us/eng))|Signle origin|Bolivia|Copacabana Sol De La Mañana|24 January 2025|This coffee holds _exactly_ what I wanted on this [relatively] cold January morning: a hearty body with some rich sweetness to it (coconut and vanilla) while retaining a degree of lightness that affords each constituent flavor space to reveal itself.|V60| 
